...
<div class="full-container  d-f-c">
    ...
    <div class="container">
        <div class="inner-title primary-txt">
            Instruction
        </div>
        <ul>
            <li>
            ...
            <li>
                <span class="primary-txt">Request : </span>All grievances will be seen by committee members, stay patient after posting a grievance. You will get the Solution as soon as possible.
            </li>
            <li>
                <span class="primary-txt">Note :</span> If you have not got a satisfactory redress of your grievance within a reasonable period of time, contact the committee member, who have given the solution, via Email Only.

            </li>            
        </ul>
        <p>
            The Student's Grievance Cell desires to promote and maintain a conducive and unprejudiced educational environment.
        </p>
        <p>
    ...
    <div class="container">
        <div class="team-area-row">
            <div class="team-box d-f-c">
                <div class="img_box">
                    <img src="{{asset('images/dev-team/dev-janvi.png')}}" alt="">
                </div>
                <span>
                    Janvi Thakkar
                </span>
...
{{-- <div class="body">
    ...
    <div class="dev-team" style="margin-top: 50px">
